        ...
        public class Builder {
            ...
            private void VerifyInputCondition1() {
                ...
                for (int i = 0; i < Task.Groups.Count; i++) {
                    ...
                    if (totalHours > qh) {
                        throw new Exception($"Group {Task.Groups[i].Name} exceeds the maximum allowed hours.");
                    }
                }
            }
            ...
            private void VerifyInputCondition2() {
                ...
                for (int j = 0; j < Task.Professors.Count; j++) {
                    ...
                    if (totalHours > qh) {
                        throw new Exception($"Professor {Task.Professors[j].Name} exceeds the maximum allowed hours.");
                    }
                }
            }
            // TODO: write test for this 
